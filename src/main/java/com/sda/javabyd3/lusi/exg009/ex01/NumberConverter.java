...
public class NumberConverter {
    private HashMap<Integer, String> unityMap = new HashMap<>();

    private HashMap<Integer, String> textMapLess20 = new HashMap<>();

    private HashMap<Integer, String> tensMap = new HashMap<>();

    /**
     * Class Number converter constructor. Create instance of the class
     * and initialize all internal values.
     */
