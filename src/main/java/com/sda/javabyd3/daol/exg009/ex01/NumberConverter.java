...
/**
 * Class converts number value to text value. Ex. if you provide 23 class will convert value to "dwadzieścia trzy"
 */
public class NumberConverter {
    ...
    public NumberConverter(){
        ...
        tensMap.put(6, "sześdziesiąt");
        tensMap.put(7, "siedemdziesiąt");
        tensMap.put(8, "osiemdzieśiąt");
        tensMap.put(9, "dziewięćdziesiąt");
    }

    /**
     * Convert provider integer value by user to
    ...
    public String convertToString(Integer number) {
        ...
        if (number < 10) {
            ...
            if (number % 10 == 0) {
                ...
                result = tensMap.get(tensDigit) + " " + textMap.get(unityDigit);
            }
        }
        return result;
    }
